	...
	if (rf.is_open()) {
		while (!rf.eof()) {
			...
			if (rf.eof())
				...
				//세 개로 분할한 정보를 string, pair<double,double> 형식으로 넣는다.(모든 지하철역)
